...
export default function Main() {
  ...
  const saveImage = async () => {
    if (!blob?.src) {
      toast.error("There's nothing to save, paste the screenshot first!");
      return;
    }
    if (window.pirsch) {
      ...
      .then(async (data) => {
        domtoimage
          ...
          .then(async (data) => {
            ...
            a.href = data;
            a.download = `pawelzmarlak-${new Date().toISOString()}.png`;
  ...
  const copyImage = () => {
    if (!blob?.src) {
      toast.error("There's nothing to copy, paste the screenshot first!");
      return;
    }
    ...
    if (isSafari) {
      ...
      alert("Firefox doesn't support this functionality");
    }
  };
      ...
      <div className="sticky top-0 flex items-center lg:min-h-screen">
        ...
        >
          ...
          <div className="relative flex flex-row flex-wrap items-start justify-start space-y-5 lg:items-start lg:flex-col lg:space-y-4">
            ...
            <div className="flex items-center justify-between w-full">
              <div className="text-sm font-semibold dark:text-white">
              Rounding of the screenshot corners
              </div>
              <div>
                <select
            ...
            <div className="flex items-center justify-between w-full">
              ...
              <div>
                ...
                >
                  ...
                  <option value="pl-0 pt-0">Upper left corner</option>
                  <option value="pt-0 pr-0">Upper right corner</option>
                  <option value="pb-0 pl-0">Lower left corner</option>
                  <option value="pb-0 pr-0">Lower right corner</option>
                </select>
              </div>
            </div>
            <div className="flex items-center justify-between w-full">
              ...
              <div>
                ...
                >
                  ...
                  <option value="shadow-lg">Little</option>
                  <option value="shadow-xl">Medium</option>
                  <option value="shadow-2xl">A lot</option>
                </select>
              </div>
            </div>
            <div className="flex items-center justify-between w-full">
